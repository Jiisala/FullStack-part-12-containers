...
router.post('/', async (req, res) => {
  ...
  const todosCreated = Number((await redis.getAsync('added_todos')))
  const todosIncremented = todosCreated ? Number(todosCreated) +1 : 1
  redis.setAsync('added_todos', todosIncremented)  
